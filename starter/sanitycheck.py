...
sys.path.append("/home/ryo/work/github/nd0821-c3-starter-code")
FAIL_COLOR = "\033[91m"
OK_COLOR = "\033[92m"
WARN_COLOR = "\033[93m"
...
def run_sanity_check(test_dir):
    ...
    # FAIL_COLOR+f"No directory named {test_dir} found in {os.getcwd()}"
    print(
        "This script will perform a sanity test to ensure your code meets the"
    ...
    if not test_functions_for_get:
        ...
        print(
            ...
            This MUST test both the status code as well as the contents of the"
              " request object.\n"
        )
    ...
    if not test_functions_for_post:
        ...
        if len(test_functions_for_post) == 1:
            ...
            print(
                FAIL_COLOR
                + "Please make sure you have two test cases for the"
                  " POST() method."
                + "\nOne test case for EACH of the possible inferences"
                  " (results/outputs) of the ML model.\n"
            )
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_CODE:
            ...
            print(
                ...
                + "One or more of your test cases for POST() do not seem"
                  " to be testing the response code.\n"
            )
